...
const markdownReducer = (state=DEFAULT_STATE, action) => {
    switch (action.type) {
...
function App() {
    ...
    const markdown = ReactRedux.useSelector((state) => state);
    ...
    return React.createElement(
      ...
      React.createElement('div', { id: 'resizable-handle' }),
  ...
  ReactDOM.render(
    ...
    document.getElementById('root') // Change 'app' to 'root'
  );
